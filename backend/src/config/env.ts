...
export const config = {
  ...
  azure_instance_name: process.env.AZURE_OPENAI_INSTANCE_NAME || '',
  azure_deployment_name: process.env.AZURE_OPENAI_DEPLOYMENT_NAME || '',
  azure_embed_deployment_name: process.env.AZURE_OPENAI_EMBED_DEPLOYMENT_NAME || '',
  azure_api_version: process.env.AZURE_OPENAI_API_VERSION || '2024-02-15-preview',
  azure_model: process.env.AZURE_OPENAI_MODEL || 'gpt-4',
  azure_embed_model: process.env.AZURE_OPENAI_EMBED_MODEL || 'text-embedding-3-large',
  ollama: {
